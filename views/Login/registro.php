...
<form action="../../controllers/registro_controler.php" method="POST" id="msform">
    ...
    <fieldset>
      ...
      <a href="index.php"><input type="button" name="" class="previous action-button" value="Anterior" /></a> 
    ...
    <fieldset>
      ...
      <input type="button" name="previous" class="previous action-button" value="Anterior" />
      <input type="submit" name="submit" class="btn btn-primary text-white active" 
      style="width: 100px; font-weight: bold; color: white; border: 0 none; border-radius: 1px; cursor: pointer; padding: 10px 5px; margin: 10px 5px;" value="Enviar" />
    </fieldset>
  </form>
