...
public function tel($telefono,$idUsuario){
    ...
    try {
        ...
        $connection->prepare($query)->execute([$telefono,$idUsuario['id_usuario']]);
    } catch (PDOException $e) {
        exit("ERROR:".$e->getMessage());
    }finally{
        $conection = null;
...
public function datosEmpresa($empresa,$actividadLaboral,$telefonoTrabajo,$years,$meses,$sueldo,$direccionCalleTrabajo,$provinciaTrabajo, $municipioTrabajo,$idUsuario){
    ...
    try {
        ...
        $connection->prepare($query)->execute([$empresa,$actividadLaboral,$telefonoTrabajo,$years,$meses,$sueldo,$direccionCalleTrabajo,$provinciaTrabajo,$municipioTrabajo,$idUsuario['id_usuario']]);
